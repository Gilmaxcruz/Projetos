...
namespace Identity.Extensions
{
    public class CustomAuthorization //referencia para validar as claims
    {
        ...
        public class ClainsAuthorizeAttribute : TypeFilterAttribute //Filtro do aspnet
        {
            public ClainsAuthorizeAttribute(string claimName, string claimValue): base(typeof(RequisitoClainFilter))
            {
